    ...
    <div className="w-full min-h-screen bg-white font-poppins">
      ...
      <div className="w-full bg-gray-900 text-white py-2 px-4 flex justify-center items-center">
        <div className="flex flex-wrap justify-center items-center gap-4">
          ...
          <a href="#" className="w-[68px] h-[24px] text-[14px] leading-[24px] font-[600] text-center underline">
            ShopNow
          </a>
          <select className="bg-gray-900 text-white text-[14px] focus:outline-none cursor-pointer h-[24px]" defaultValue="English">
      ...
      <header className="w-full bg-white text-gray-900 shadow-sm py-3 px-6 flex flex-wrap justify-between items-center">
        ...
        <nav className="hidden md:flex space-x-8 text-[16px] font-medium">
          ...
          <a href="#" className="hover:text-gray-600 transition">SignUp</a>
        </nav>
        <div className="flex items-center space-x-4 mt-2 md:mt-0">
          <div className="relative hidden sm:flex items-center">
            <input type="text" placeholder="What are you looking for?" className="border border-gray-300 rounded-full pl-4 pr-10 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-gray-400"/>
          </div>
          {/* Heart */}
      ...
      <div className="ml-8 mt-4 flex gap-4">
        <div className="flex flex-col gap-4 w-[217px]">
          {categories.map((category) => (
            <a key={category} href="#" className="flex justify-between items-center text-gray-900 hover:text-gray-600 font-medium">
              {category}
            </a>
          ))}
        </div>
        <div className="w-[1px] h-[384px] bg-gray-400 opacity-30 mt-4"></div>
        <div>
          <Image src="/Frame.png" alt="Categories Banner" width={892} height={384} />
        </div>
      </div>
...
<div className="mt-8 px-8">
 ...
 {/* View All Button */}
  ...
  {/* Divider Line Below Products */}
  <div className="mt-8 w-full h-[1px] bg-gray-300"></div>
</div>
...
<div className="mt-12 px-8">
  ...
  <div className="flex items-center mb-6">
    ...
    <h2 className="text-lg text-gray-700 mr-2 font-medium">Featured</h2>
